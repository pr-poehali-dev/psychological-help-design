    ...
    return (
      <div className="min-h-screen gradient-primary flex items-center justify-center">
        <div className="text-center animate-scale-in">
          ...
          <h1 className="text-4xl font-bold text-white mb-4">MindPal</h1>
          <div className="flex gap-2 justify-center">
            <div className="w-3 h-3 bg-white rounded-full animate-pulse-glow" style={{ animationDelay: '0s' }}></div>
            <div className="w-3 h-3 bg-white rounded-full animate-pulse-glow" style={{ animationDelay: '0.2s' }}></div>
            <div className="w-3 h-3 bg-white rounded-full animate-pulse-glow" style={{ animationDelay: '0.4s' }}></div>
          </div>
        </div>
      </div>
    );
      ...
      <Tabs defaultValue="home" className="w-full">
        <div className="container max-w-4xl mx-auto p-4 pb-20">
          <div className="mb-6 animate-fade-in">
            <Card className="p-6 gradient-card border-none">
          ...
          <TabsContent value="home" className="space-y-6">
            <div className="grid grid-cols-2 gap-4 animate-fade-in">
              <Card className="p-6 hover:shadow-lg transition-shadow cursor-pointer gradient-card border-purple-200">
              ...
              <Card className="p-6 hover:shadow-lg transition-shadow cursor-pointer gradient-card border-pink-200">
                <div className="text-center">
                  <div className="text-4xl mb-3">🎯</div>
              ...
              <Card className="p-6 hover:shadow-lg transition-shadow cursor-pointer gradient-card border-blue-200">
                <div className="text-center">
                  <div className="text-4xl mb-3">💭</div>
              ...
              <Card className="p-6 hover:shadow-lg transition-shadow cursor-pointer gradient-card border-green-200">
                <div className="text-center">
                  <div className="text-4xl mb-3">📊</div>
            ...
            <Card className="p-6 animate-fade-in">
              <div className="flex items-center gap-6 mb-8">
                <Avatar className="w-24 h-24 text-5xl">
                  <AvatarFallback className="gradient-primary text-white text-5xl">
                    {selectedCharacter}
                  </AvatarFallback>
                </Avatar>
                <div className="flex-1">
        ...
        <TabsList className="fixed bottom-0 left-0 right-0 w-full h-16 rounded-none border-t bg-card/95 backdrop-blur-sm">
          <TabsTrigger value="home" className="flex-1 h-full data-[state=active]:gradient-primary data-[state=active]:text-white">
            <div className="flex flex-col items-center gap-1">
              <Icon name="Home" size={20} />
              <span className="text-xs">Главная</span>
            </div>
          </TabsTrigger>
          <TabsTrigger value="diary" className="flex-1 h-full data-[state=active]:gradient-primary data-[state=active]:text-white">
            <div className="flex flex-col items-center gap-1">
              <Icon name="BookOpen" size={20} />
              <span className="text-xs">Дневник</span>
            </div>
          </TabsTrigger>
          <TabsTrigger value="profile" className="flex-1 h-full data-[state=active]:gradient-primary data-[state=active]:text-white">
            <div className="flex flex-col items-center gap-1">
